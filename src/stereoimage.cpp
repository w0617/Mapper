...
StereoImage::StereoImageParameters* StereoImage::m_forSaveDepth = new StereoImage::StereoImageParameters();
bool StereoImage::waitForReconstruction = false;
...
void StereoImage::SaveKittiDepthImages( std::string m_kittiImagePath, int index )
{
    ...
    uint temp;
    int width = m_forSaveDepth->width;
    int height = m_forSaveDepth->height;
    ...
    addLeftDepth = m_forSaveDepth->D1;
    addRightDepth = m_forSaveDepth->D2;
